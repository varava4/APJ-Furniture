(() => {
    ...
    function initSliders() {
        if (document.querySelector(".images-main__slider")) new swiper_core_Swiper(".images-main__slider", {
            ...
            effect: "fade",
            pagination: {
                el: ".images-main__pagination",
                type: "fraction"
            },
            navigation: {
                prevEl: ".images-main__button-prev",
                nextEl: ".images-main__button-next"
            },
            on: {}
        });
        if (document.querySelector(".left-interiors__slider")) new swiper_core_Swiper(".left-interiors__slider", {
            ...
            effect: "fade",
            navigation: {
                prevEl: ".left-interiors__button-prev",
                nextEl: ".left-interiors__button-next"
            },
            on: {}
        });
    }
